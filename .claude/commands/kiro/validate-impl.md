...
- **Success Criteria**:
  ...
  - No regressions in existing functionality </background_information>
...
- **No Implementation Found**: If no `/kiro:spec-impl` in history and no `[x]` tasks, report "No
  implementations detected"
- **Test Command Unknown**: If test framework unclear, warn and skip test validation (manual
