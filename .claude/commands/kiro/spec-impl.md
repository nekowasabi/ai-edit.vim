...
- **Mission**: Execute implementation tasks using Test-Driven Development methodology based on
...
- **Suggested Action**: "Complete previous phases: `/kiro:spec-requirements`, `/kiro:spec-design`,
  `/kiro:spec-tasks`"
